...
from network import HDFNet_VGG16_b_learn as HDFNet_VGG16_b
...
class Trainer:
    def __init__(self, args):
        ...
        self.net = HDFNet_VGG16_b().to(self.dev)
        ...
        for curr_epoch in range(self.start_epoch, self.end_epoch):
            ...
            for train_batch_id, train_data in enumerate(self.tr_loader):
                ...
                if self.data_mode == "RGBD":
                    ...
                    train_depths = train_other_data[-1].float()
